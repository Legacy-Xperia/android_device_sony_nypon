...
Patch android source code :
    ...
    patch -p1 < device/sony/nypon/patches/packages_apps_BluetoothExt.patch
    patch -p1 < device/sony/nypon/patches/external_bluetooth_bluedroid.patch
    patch -p1 < device/sony/nypon/patches/external_wpa_supplicant_8.patch
...
Our step is optional!!! Use only if you going to sync CM source code daily, than simple revert each patch before you sync CM source code :
    ...
    patch -p1 -R < device/sony/nypon/patches/packages_apps_BluetoothExt.patch
    patch -p1 -R < device/sony/nypon/patches/external_wpa_supplicant_8.patch
